defmodule JobService.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule JobSvcWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :job_svc
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: JobServiceWeb.Router, endpoint: JobServiceWeb.Endpoint},
      {Plugins.Ecto, oban_repos: [JobService.Repo]},
      Plugins.Oban,
      JobService.OsMetrics.PromExPlugin

      # Add your own PromEx metrics plugins
      # JobSvc.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:job_svc, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
