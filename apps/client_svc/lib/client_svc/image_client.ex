defmodule ImageClient do
  ...
  def convert_png(png_binary, user_email, opts \\ []) do
    ...
    Tracer.with_span "image_client.convert_png", %{kind: :client} do
      ...
      # Send request using Req with base_url pattern (OpentelemetryReq will propagate trace context)
      response =
  ...
  def convert_many_pngs(png_paths, opts \\ []) do
    ...
    Logger.info("Converting #{length(png_paths)} images with concurrency #{concurrency}...")
